...
def setDefaultSettings(d, mustHaveSettings, optionalSettings):
	...
	for optional, value in optionalSettings.iteritems():
...
class DataSettings(object):
	...
	def _createBarPatternSettings(self, module):
		config = dict(dt=module.PATTERN_DT,
...
class SimulationSettings(object):
	...
	def _createSettings(self, module):
		...
		config = dict(dt=module.DT, 
					  simulationRNGSeed=42, # pcsim bug
					  simulationChain=simChain,
					  model=module.NETWORK_MODEL,
					  modelAdditionalParams=module.NETWORK_PARAMS,
					  showLearningProgress=module.SHOW_LEARNING_PROGRESS)
